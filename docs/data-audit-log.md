...
| **2026-09-24** | Linhas Tronco Tier 3 — Fase 1 (`transmissionLinesData.ts`) | ONS (PAR/RAP), ANEEL (SIGEL), Concessionárias (ISA CTEEP, Taesa, Axia, Neoenergia, CGT Eletrosul) | 21 novas linhas auditadas (total 37): Calha Norte (Tucuruí–Macapá–Lechuga), Tronco 765 kV Itaipu, Anel 440 kV Paulista, Escoamento NE 500 kV, Tronco Sul 525 kV e Centro-Oeste 500 kV com subestações oficiais e `accessedAt` | ✅ Aprovado (100% ancoradas em SEs georreferenciadas) | `HEAD` |
| **2026-09-24** | Linhas Tronco Tier 3 — Fase 2 (`transmissionLinesData.ts`) | ONS (PAR/RAP), ANEEL (SIGEL), Eletronuclear, SPIC Brasil, Copel, Taesa, ISA CTEEP, Cemig GT | 15 novas linhas auditadas (total 52): Escoamento Nuclear Angra, Eixo Histórico Furnas 500 kV, São Simão–Marimbondo, Polo Eólico RN (Açu–Natal), Eixo Ceará/Fortaleza/Pecém, Teles Pires/Sinop, Agro Sudoeste Goiano, Interligação MT–MS 230 kV, Salto Caxias/Segredo Sul, Candiota e Anel MG Mesquita–BH | ✅ Aprovado (100% ancoradas em SEs georreferenciadas e com `accessedAt`) | `HEAD` |
| **2026-09-24** | Intercâmbios Regionais & Gargalos (`interchangeData.ts`, `gridData.ts`) | ONS — Procedimentos de Rede (Submódulos 23.3, 23.4, 23.5) & Dados Abertos | 4 fronteiras auditadas (FNESE, FNEN, FNSE, FSSE), limites dinâmicos/nominais, fontes primárias com `accessedAt`, perfis rotulados como ilustrativos e recorde histórico de 106.532 MW | ✅ Aprovado (nomenclatura operativa oficial ONS padronizada) | `b42552c` |
| **2026-09-24** | Usinas Hidrelétricas — Lote 1: Top 16 (`powerPlantsData.ts`) | [ANEEL — SIGA / SIGEL](https://siga.aneel.gov.br/) | 16 maiores UHEs (>65 GW): Itaipu, Belo Monte, Tucuruí, Paulo Afonso, Jirau, Santo Antônio, Ilha Solteira, Xingó, Itumbiara, Teles Pires, São Simão, Foz do Areia, Jupiá, Porto Primavera, Luiz Gonzaga/Itaparica, Marimbondo | ✅ Aprovado (retificados 1.488 MW → 1.440 MW em Marimbondo; operador de São Simão para SPIC Brasil; consolidadas concessões Axia Energia; 100% com CEG e `accessedAt`) | `HEAD` |
