...
const ROOT_URL_DEBT = new Set<string>([
  ...
  'transmissionLines:linha-jurupari-macapa',
  'transmissionLines:linha-tucurui-vila-do-conde',
  'transmissionLines:linha-tucurui-maraba-imperatriz',
  'transmissionLines:linha-xingu-tucurui',
  'transmissionLines:linha-itaipu-ivaipora-765',
  'transmissionLines:linha-ivaipora-itabera-765',
  'transmissionLines:linha-itabera-tijuco-preto-765',
  'transmissionLines:linha-ilha-solteira-araraquara',
  'transmissionLines:linha-araraquara-bauru-embu-guacu',
  'transmissionLines:linha-jupia-bauru-440',
  'transmissionLines:linha-porto-primavera-assis',
  'transmissionLines:linha-sao-joao-piaui-milagres',
  'transmissionLines:linha-gilbues-sao-joao-piaui',
  'transmissionLines:linha-barreiras-rio-das-eguas',
  'transmissionLines:linha-pocoes-padre-paraiso-gov-valadares',
  'transmissionLines:linha-gov-valadares-mutum-rio',
  'transmissionLines:linha-xingo-paulo-afonso-camacari',
  'transmissionLines:linha-campos-novos-curitiba-525',
  'transmissionLines:linha-ita-caxias-gravatai-525',
  'transmissionLines:linha-serra-da-mesa-samambaia',
  'transmissionLines:linha-itumbiara-emborcacao-ribeirao-preto',
  'transmissionLines:linha-angra-rio',
  'transmissionLines:linha-furnas-adrianopolis',
  'transmissionLines:linha-sao-simao-marimbondo-ribeirao',
  'transmissionLines:linha-costa-branca-rn',
  'transmissionLines:linha-milagres-banabuiu-fortaleza',
  'transmissionLines:linha-sobral-pecem',
  'transmissionLines:linha-claudia-paranatinga',
  'transmissionLines:linha-rio-verde-itumbiara',
  'transmissionLines:linha-cuiaba-campo-grande',
  'transmissionLines:linha-salto-caxias-foz',
  'transmissionLines:linha-segredo-curitiba',
  'transmissionLines:linha-candiota-povo-novo',
  'transmissionLines:linha-sol-do-sertao-morro-chapeu',
  'transmissionLines:linha-mesquita-neves-bh',
  'transmissionLines:linha-araraquara-campinas-taubate'
]);
